/*
Stream button will be a subsection of this most likely

Contains all the relevant information that ultimately gets passed to the stream button:

Market: Stocks or Forex
Ticker Symbol
